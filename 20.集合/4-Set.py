...
'HashSet':[
    ...
    '采用HashCode算法来存取元素，具有比较好的读取和查找性能',
    {'过滤重复元素':[
        '1.调用元素HashCode获得哈希码',
        {'2.判断哈希码是否相等':[
            '不相等:录入',
...
'LinkedHashSet':[
    {'底层':[
        '一个链表来维护元素的插入顺序,存储的数据是有序的'
    ]},
    '插入:计算hashCode+维护链表,插入性能比HashSet低',
    '遍历:只需要按链表来访问元素,遍历时性能更高',
    {'内容':[
        '没有定义任何方法，只有四个构造函数',
        '所有方法都继承自HashSet',
...
'TreeSet':[
    {'底层':[
        '二叉树，每增加一个对象都会进行排序，将对象插入的二叉树指定的位置'
    ]},
    '实现了SortedSet接口,',
    ...
    {'Comparable和Comparator':[
        'Comparable接口:提供自然排序顺序',
        'Comparator接口:自定义排序函数,适用于没有自然顺序的类、或想要不同于自然顺序的顺序',
