...
s2=w.createSheet()
s2.setTitle("Kafka 处理请求的全流程")
r2=s2.getRootTopic()
r2.setTitle("Kafka 处理请求的全流程")
...
'Kafka Broker 网络通信模型':[
    {'Acceptor(mainReactor)':[
        '监听新连接的到来，与新连接建连之后轮询选择一个Processor(subReactor)管理这个连接',
