...
'简介':[
    ...
    '实现同步器的基础组件',
    '并发包中锁(ReentrantLock/Semaphore/CountDownLatch)的底层',
],
'结构':[
    '一个先进先出(FIFO)的双向队列,队列元素类型为Node',
